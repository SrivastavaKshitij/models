...
def main(_):
    ...
    with tf.Graph().as_default():
        ...
        image_preprocessing_fn = preprocessing_factory.get_preprocessing(
            preprocessing_name, is_training=True, use_grayscale=FLAGS.use_grayscale
        )
        ...
        ###########################
        ## Creating a config file to mitigate cudnn initialization error on turing architecture
