...
"""
Converting validation data into 512 images / shard  and removing everything related to training code and bounding boxes
"""
...
tf.app.flags.DEFINE_integer(
    "validation_shards", 125, "Number of shards in validation TFRecord files."
)

tf.app.flags.DEFINE_integer(
    "num_threads", 25, "Number of threads to preprocess the images."
)
...
tf.app.flags.DEFINE_string(
    "labels_file", "imagenet_lsvrc_2015_synsets.txt", "Labels file"
)
...
tf.app.flags.DEFINE_string(
    "imagenet_metadata_file", "imagenet_metadata.txt", "ImageNet metadata file"
)
...
def _process_image_files_batch(
    coder, thread_index, ranges, name, filenames, synsets, labels, humans, num_shards
):
    ...
    for s in range(num_shards_per_batch):
        ...
        for i in files_in_shard:
            ...
            example = _convert_to_example(
                filename, image_buffer, label, synset, human, height, width
            )
...
def _process_dataset(name, directory, num_shards, synset_to_human):
  ...
  """
    ...
    _process_image_files(name, filenames, synsets, labels, humans, num_shards)
...
def _build_bounding_box_lookup(bounding_box_file):
  ...
  """
    ...
    print(
        "Successfully read %d bounding boxes "
...
def main(unused_argv):
    # assert (
    #    not FLAGS.train_shards % FLAGS.num_threads
